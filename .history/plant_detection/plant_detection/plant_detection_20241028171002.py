...
class PlantDetectNode(Node):
    ...
    def image_callback(self, msg):
        ...
        result_img = self.__result_display(
            image, filtered_plants, removed_plants, weeds)

        self.img_publisher_(self.bridge.cv2_to_imgmsg(result_img, "bgr8"))
    ...
    def __result_display(self, img, filtered_plants, removed_plants, weeds):
