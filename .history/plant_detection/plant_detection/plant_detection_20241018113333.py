...
class PlantDetectNode(Node):
    ...
    def image_callback(self, msg):
        ...
        obj_list = self.__cords_to_list(obj_cords)
        new_points = self.__extract_yolo_points(obj_cords)
    ...
    def __cords_to_list(self, obj_cords):
        obj_list = []
    ...
    def __extract_yolo_points(self, obj_cords):
        new_points = []
        for obj_name, obj_coord in obj_cords.items():
            new_points.append({
                'Object Name': obj_name,
