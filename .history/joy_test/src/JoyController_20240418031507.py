...
class Joy_controller(Node):
    ...
    def listener_callback(self, JoyData):
        ...
        Motion_command.linear_x = np.interp(JoyData.axes[6], velOriginalRange, vel_target_range);
        Motion_command.center_rotation_rad = np.interp(JoyData.axes[0], angle_original_range, angle_target_range);
