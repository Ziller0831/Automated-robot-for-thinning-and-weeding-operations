...
class TrajectoryPlanNode(Node):
    ...
    def traject_callback(self, msg):
        ...
        self.plant_cord = msg.data

    def timer_callback(self):
        planed_cord = self.__trajectory_plan()
...
def main(args=None):
    ...
    trajectory_plan_node = TrajectoryPlanNode("trajectory_planer")
    rclpy.spin(trajectory_plan_node)
    trajectory_plan_node.destroy_node()
    rclpy.shutdown()
